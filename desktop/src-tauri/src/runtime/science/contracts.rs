...
const SCIENCE_RUNTIME_SELECTION_FILE: &str = "selection.v1.json";
const MAX_SCIENCE_RUNTIME_SELECTION_BYTES: u64 = 16 * 1024;
const SCIENCE_RUNTIME_UPDATE_INTERVAL_MS: i64 = 24 * 60 * 60 * 1_000;
