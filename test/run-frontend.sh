...
fail=0
for f in desktop/src/main.js desktop/src/preview-adapter.js desktop/src/ipc-client.js desktop/src/codex-controller.js desktop/src/profile-controller.js desktop/src/runtime-controller.js desktop/src/codex-auth-protocol.js desktop/src/runtime-status-state.js desktop/src/model-catalog-state.js test/codex_auth_ui.test.mjs test/runtime_status_state.test.mjs test/model_catalog_state.test.mjs test/profile_preview_mock.test.mjs desktop/src/skill-page.js desktop/src/skill-page-state.js test/skill_page_state.test.mjs; do
