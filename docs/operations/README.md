...
- [生产链路验收](real-machine-acceptance.md)：唯一回答重要重构决策怎样映射到 production source、exact artifact、isolated-live、authorized-live，以及各层护栏、RM 场景和收尾怎样执行。
- [Claude Science 生产链路探针合同](science-probe-spec.md)：回答 current source、exact artifact、isolated-live 与逐项 authorized-live 探针的 fixture、授权、gate、判定、停止、清理和证据输出；actual status 只从日期化 evidence 进入。
