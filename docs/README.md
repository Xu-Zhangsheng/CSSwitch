...
- [2026-08-05 O1-C managed Science launch phase closure](audits/2026-08-05-o1-c-science-launch-phase.md)：最近 source-only implementation closure；下一步必须先做新的只读再基线，不自动进入 durable stepwise compensation、read model、Science provenance 或其他候选。
