...
- [2026-08-04 Post-D0 只读重新基线](audits/2026-08-04-post-d0-rebaseline.md)：最新 source-only 架构与治理基线；当前 sole NEXT 建议以实时复核后的 [known issues](../.agents/context/known-issues.md) 为准。
